...
Note 3: To show the state of all instances in the evaluation setup, execute `./ec2-test list`. Use this command to make sure that all instances are in state `terminated` after tearing down the setup.
